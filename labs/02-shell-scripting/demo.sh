...
clear_section "RHCSA Módulo 02: Scripting y Automatización en Bash - Tema: 1. Definición de Variables y Operaciones Aritméticas"
...
clear_section "RHCSA Módulo 02: Scripting y Automatización en Bash - Tema: 2. Condicionales (if/then/else) en Archivos y Números"
...
clear_section "RHCSA Módulo 02: Scripting y Automatización en Bash - Tema: 3. Estructuras de Repetición: Bucles for y while"
...
clear_section "RHCSA Módulo 02: Scripting y Automatización en Bash - Tema: 4. Manejo de Argumentos dentro de un Script"
