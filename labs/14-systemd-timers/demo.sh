...
clear_section "RHCSA Módulo 14: Systemd Timers (RHEL 10) - Tema: 1. Crear una Unidad Timer"
...
# 2. Probar Timer
clear_section "RHCSA Módulo 14: Systemd Timers (RHEL 10) - Tema: 2. Probar el Timer"
...
clear_section "RHCSA Módulo 14: Systemd Timers (RHEL 10) - Tema: 3. Configurar Servicio Asociado"
run_demo_cmd "Verifica servicio" "systemctl status rhcsa-timer.service | head -3 || true"
sleep 2.0

# 4. Validar
clear_section "RHCSA Módulo 14: Systemd Timers (RHEL 10) - Tema: 4. Validar"
