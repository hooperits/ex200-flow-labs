...
clear_section "RHCSA Módulo 12: SSH y Sudoers (RHEL 10) - Tema: 1. Configurar Autenticación por Claves SSH"
...
clear_section "RHCSA Módulo 12: SSH y Sudoers (RHEL 10) - Tema: 2. Configurar sudoers"
...
clear_section "RHCSA Módulo 12: SSH y Sudoers (RHEL 10) - Tema: 3. Restringir Acceso SSH"
...
# 4. Probar y Validar
clear_section "RHCSA Módulo 12: SSH y Sudoers (RHEL 10) - Tema: 4. Probar Config"
