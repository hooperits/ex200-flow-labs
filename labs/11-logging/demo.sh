...
clear_section "RHCSA Módulo 11: Logging Avanzado (RHEL 10) - Tema: 1. Inspeccionar Logs con journalctl"
...
clear_section "RHCSA Módulo 11: Logging Avanzado (RHEL 10) - Tema: 2. Configurar Persistencia de Logs"
...
clear_section "RHCSA Módulo 11: Logging Avanzado (RHEL 10) - Tema: 3. Configurar rsyslog"
...
# 4. Probar y Validar
clear_section "RHCSA Módulo 11: Logging Avanzado (RHEL 10) - Tema: 4. Probar Logs"
