...
clear_section "RHCSA Módulo 06: Seguridad del Sistema, Firewalld y SELinux - Tema: 1. Configuración de Firewall (firewalld)"
...
clear_section "RHCSA Módulo 06: Seguridad del Sistema, Firewalld y SELinux - Tema: 2. Modos y Estados Generales de SELinux"
...
clear_section "RHCSA Módulo 06: Seguridad del Sistema, Firewalld y SELinux - Tema: 3. Administración de Contextos de SELinux"
...
clear_section "RHCSA Módulo 06: Seguridad del Sistema, Firewalld y SELinux - Tema: 4. Control Dinámico mediante Booleanos de SELinux"
