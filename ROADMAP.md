...
- **2026-06-30 / Matrix + re-audit update**: Added official refs for 01-03/10-15 + re-check example for Lab 01. Audit cleaned. Post-task. Improves Rule 1 + audit hygiene.
