...
- **2026-06-30 / Lab 12 instructions full flesh**: Expanded instructions.md for SSH/Sudoers with detailed cmds (ssh-keygen + authorized_keys, sudoers.d + visudo, sshd_config sed + restart, tests, challenge ref). Matches demo/verify. Post-task + re-audit updated. Now 5/6 Phase1 full (10,12-15); only 11 basic+. Improves 1,2,5.
