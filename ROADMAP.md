...
- **2026-06-30 / Matrix expansion (post Phase1)**: Added rough % coverage breakdown by lab (~82% est.) and notes in objective-matrix.md. Re-audit/audit updated. Small scoped per rules. Improves traceability (Rule 1).
