...
- **2026-06-30 / Matrix expansion**: Added rough % table + expanded Detailed Examples with specific cmds for labs 10-15 (journalctl, sysctl, ssh-keygen, etc.). Gaps updated. Post-task in audit. Improves Rule 1 traceability.
