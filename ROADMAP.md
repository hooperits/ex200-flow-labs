...
- **2026-06-30 / Lab 14 instructions full flesh + re-audit note**: Expanded instructions for 14 (unit creation, systemctl ops, log doc). Added compact re-audit summary to audit (Phase1: 3 full labs now). Post-task applied. Improves 1,2,5.
