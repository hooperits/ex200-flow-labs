...
**Created**: 2026-06-28  
**Status**: Draft  
**Input**: Cuarto módulo de laboratorios y rap sobre la Gestión de Usuarios, Grupos, Permisos Especiales (SGID, Sticky Bit) y ACLs para el examen RHCSA EX200 (RHEL 9).
