# Requirements Checklist: 02-shell-scripting
...
- [x] FR-004: `instructions.md` details the challenge requirements in Spanish (writing a shell script that uses conditionals and loops to process files/directories).
