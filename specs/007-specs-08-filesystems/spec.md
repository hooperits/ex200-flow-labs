...
**Created**: 2026-06-28  
**Status**: Draft  
**Input**: Octavo módulo de laboratorios y rap sobre Creación de Sistemas de Archivos, Montaje Persistente en `/etc/fstab`, y Montaje de Recursos de Red NFS y SMB/CIFS (tanto de forma persistente como a demanda mediante Autofs) para el examen RHCSA EX200 (RHEL 9).
