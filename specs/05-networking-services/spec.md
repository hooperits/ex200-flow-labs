...
- **FR-004**: La letra de rap técnico en español MUST guardarse en `/home/juanca/RHCSA-EX200-lyrics/05-networking-services.txt`, rimando la sintaxis de `nmcli`, `hostnamectl` y las estrellas del formato `cron` (`* * * * *`).
